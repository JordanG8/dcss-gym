...
$('#webtiles').src=location.origin+'/live';$('#live').onclick=()=>setMode('live');$('#openLive').onclick=()=>window.open(location.origin+'/live','_blank');$('#tileReplay').onclick=()=>window.open('http://127.0.0.1:8102','_blank');$('#replay').onclick=()=>setMode('replay');$('#play').onclick=toggle;$('#seek').oninput=e=>show(+e.target.value);loadGames();
</script>"""
